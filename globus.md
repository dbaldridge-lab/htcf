# Globus
Globus is a program that can help you transfer large files efficiently. Globus will check file integrity and transfer progress and alert you to issues. 
...
## Transferring Files
[See Tutorial](https://docs.globus.org/guides/tutorials/manage-files/transfer-files/)

Select the split pane button.

On one pane, enter the path to the files and/or directories you will move. 
In the other pane, enter the path to the destination.
...
<details>
  <summary>Transferring Files Locally</summary>
...
Select Collections. You should see your Laptop if the collection is setup correctly.
